...
console.log(arr[2]);// Q1-1. arr에서 3 출력하기
// Hint: 인덱싱은 0부터 시작!

console.log(arr.slice(0, 3));/// Q1-2. arr에서 [1, 2, 3] 출력하기
// Hint: slice 함수를 사용해볼까요?

console.log(arr2[2]);// Q1-3. arr2에서 [8, 9] 출력하기
// Hint: 배열 안에 원소가 배열일 뿐!

console.log(arr2[1][2]);// Q1-4. arr2에서 [4, 5, 6] 출력하기
// Hint: 원소 안의 원소!
...
console.log(obj.age);// Q2-1. 멋쨍이사자의 나이를 obj 객체로부터 출력하기
// Hint: obj.~~

console.log(obj.gpa.Computer);// Q2-2. 멋쨍이사자의 Computer 학점(A+)을 obj 객체로부터 출력하기

console.log(obj.friends[0].age);// Q2-3. 아기사자 나이(21)를 obj 객체로부터 출력하기
// Hint: obj 안에 배열

console.log(obj.friends[1].lecture[1][2]);// Q2-4. 코딩사자가 수강한 강의 중에서 "비즈니스디자인"을 obj 객체로부터 출력하기
...
console.log(arr3.map((num) => num * 10));// Q3-1. map 함수와 arr3을 활용하여 [10, 20, 30, 40, 50, 60]을 출력하시오.

console.log(arr3.filter((num) => num % 2 === 1));// Q3-2. filter 함수와 arr3을 활용하여 [1, 3, 5]를 출력하시오.
